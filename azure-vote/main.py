...
from opentelemetry.exporter.opentelemetry_proto.http.trace_exporter import OTLPSpanExporter
from opentelemetry.exporter.opentelemetry_proto.http._log_exporter import OTLPLogExporter
